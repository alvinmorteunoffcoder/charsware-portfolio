          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch mb-12">
              ...
              <motion.div variants={floatingItem} className="w-full h-full bg-zinc-900/30 rounded-2xl border border-zinc-800/50 shadow-2xl overflow-hidden hover:border-white/10 transition-colors backdrop-blur-md transform-gpu flex flex-col group relative" style={{ transformStyle: 'preserve-3d' }}>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
                <div className="relative w-full aspect-[9/16] bg-black overflow-hidden flex-shrink-0 flex items-center justify-center pointer-events-none">
                  <iframe className="w-full h-full" src="https://www.instagram.com/reel/DFUsUg7TumB/embed/?hidecaption=1" title="Instagram Reel 4" frameBorder="0" scrolling="no" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                </div>
                <div className="p-6 flex-grow flex flex-col justify-center pointer-events-none">
                  <h3 className="text-xl text-white font-medium mb-2">Instagram Reel 4</h3>
                  <p className="text-zinc-400 text-sm">A fast-paced, high-energy edit for a brand.</p>
                </div>
              </motion.div>
              ...
              <motion.div variants={floatingItem} className="w-full h-full bg-zinc-900/30 rounded-2xl border border-zinc-800/50 shadow-2xl overflow-hidden hover:border-white/10 transition-colors backdrop-blur-md transform-gpu flex flex-col group relative" style={{ transformStyle: 'preserve-3d' }}>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
                <div className="relative w-full aspect-[9/16] bg-black overflow-hidden flex-shrink-0 flex items-center justify-center pointer-events-none">
                  <iframe className="w-full h-full" src="https://www.instagram.com/reel/DFC3AQuzIvv/embed/?hidecaption=1" title="Instagram Reel 5" frameBorder="0" scrolling="no" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                </div>
                <div className="p-6 flex-grow flex flex-col justify-center pointer-events-none">
                  <h3 className="text-xl text-white font-medium mb-2">Instagram Reel 5</h3>
                  <p className="text-zinc-400 text-sm">A fast-paced, high-energy edit for a brand.</p>
                </div>
              </motion.div>
              ...
              <motion.div variants={floatingItem} className="w-full h-full bg-zinc-900/30 rounded-2xl border border-zinc-800/50 shadow-2xl overflow-hidden hover:border-white/10 transition-colors backdrop-blur-md transform-gpu flex flex-col group relative" style={{ transformStyle: 'preserve-3d' }}>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
                <div className="relative w-full aspect-[9/16] bg-black overflow-hidden flex-shrink-0 flex items-center justify-center pointer-events-none">
                  <iframe className="w-full h-full" src="https://www.instagram.com/reel/DFAX9XZsm-A/embed/?hidecaption=1" title="Instagram Reel 6" frameBorder="0" scrolling="no" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                </div>
                <div className="p-6 flex-grow flex flex-col justify-center pointer-events-none">
                  <h3 className="text-xl text-white font-medium mb-2">Instagram Reel 6</h3>
                  <p className="text-zinc-400 text-sm">A fast-paced, high-energy edit for a brand.</p>
                </div>
              </motion.div>
            </div>
